		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li class='active'><a href='/templates/conoceCeti/misionVision.php'>Misi&oacute;n y Visi&oacute;n</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Misi&oacute;n y Visi&oacute;n</h2>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
                                             <img class="img img-responsive" src="../../imagenes/conoceCeti/mision.jpg">
											</p>
											<p>
											 <img class="img img-responsive" src="../../imagenes/conoceCeti/vision.jpg">
											</p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>

		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li class='active'><a href='/templates/conoceCeti/planoPlantel.php'>Plano del Plantel</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Plano del Plantel</h2>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
                                             <img class="img img-responsive" src="../../imagenes/conoceCeti/planoPlantel.png">
											</p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>

		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li class='active'><a href='/WebColomosGob/templates/conoceCeti/anuies.php'>Anuies</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Revista Confluencia</h2>

					            	</div>
					            	<div class='col-md-4 col-xs-12 pull-right '>
									    <!--imagen por encima del menu lateral-->
					            		<img class='img img-responsive' src="../../imagenes/conoceCeti/anuies-confluencia.jpg" alt="Anuies">
										<!--Menu lateral -->
										<div class='border-box submenu_relacionados'>
									        <h4 class='bottom-buffer'>Submenú de la sección</h4>
									        <hr class='red sitios_relacionados'>
									       	<ul>	<li><a href="http://www.anuiesrco.org.mx/revista/confluencia/mobile/index.html" target="_blank">Edici&oacute;n 2</a><hr class="sub-hr"></li>	
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
                                             Con el desarrollo de las tecnologías de la información y la comunicación, la Revista Confluencia RCO ha transitado de la versión trimestral e impresa y un formato electrónico y mensual, buscando ser un medio de comunicación oportuno, dinámico y expedito. Es por ello, que nos llena de gusto presentar esta nuestra Revista Confluencia, su versión digital.
                                             Te invitamos a visitar la Revista Confluencia Región Centro Occidente.
											</p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>

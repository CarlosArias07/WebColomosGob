		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li class='active'><a href='/templates/conoceCeti/directorioTelefonico.php'>Directorio Telefonico</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Directorio Telefonico</h2>
					            	...
					            	<div class='col-md-4 col-xs-12 pull-right '>
										...
										<div class='border-box submenu_relacionados'>
									        ...
									        <hr class='red sitios_relacionados'>
									       	<ul>	
											        <li><a href="/templates/conoceCeti/nuestroPlantel.php">Historia</a><hr class="sub-hr"></li>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class="article-body">
						                    <hr class="red">
						                    <p class="contenido">	
                                             <object type"application/pdf" data="../../documentos/conoceCeti/directorioTelefonico-2017.pdf"  height="1600" width="640" > </object>
										     </p>
										</div>		
					                </div>

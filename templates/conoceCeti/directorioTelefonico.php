		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li class='active'><a href='/WebColomosGob/templates/conoceCeti/directorioTelefonico.php'>Directorio Telefonico</a></li>
					                </ol>
					            </div>
					            	...
					            	<div class='col-md-4 col-xs-12 pull-right '>
										...
										<div class='border-box submenu_relacionados'>
									        ...
									        <hr class='red sitios_relacionados'>
									       	<ul>	
											        <li><a href="/WebColomosGob/templates/conoceCeti/nuestroPlantel.php">Historia</a><hr class="sub-hr"></li>

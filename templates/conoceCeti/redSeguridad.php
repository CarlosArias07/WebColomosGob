...
<html lang="es">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../../css/desplegables.css">
								    	...
								    	<div class="article-body">
											...
											<div>
												<table>
			                                        <tbody>
													    <tr>
					                                        <td colspan="3"><b>Protocolos de Seguridad</b>
						                                       <p>Para Centros Educativos Federales de EMS </p>
															   <a href="../../documentos/conoceCeti/ProtocolosSeguridadCentrosEducativosFederalesEMS2015.pdf" target="_blank">Descargar</a>
															</td>
			                                            </tr>
				                                        <tr>
				                                            <td colspan="2">&nbsp; 
					                                            <p>Acciones en Conjunto</p>
					                                            <input id="spoiler11" type="checkbox">  
                                                                <label for="spoiler11">Septiembre 2016</label>
                                                             <div class="spoiler">
					                                            <p><b>Asociación de colonos Providencia, Policia de Guadalajara y CETI</b></p>
                                                                <p class="contenido" >
					      Se les invita a todos los estudiantes, al personal y visitantes del CETI a no estacionarse en línea amarilla o esquinas, pasos peatonales y fuera de cocheras de 
					      nuestros vecinos colindantes como parte de la sana convivencia establecida en la reunión de la Red de Seguridad del CETI Plantel Colomos, en conjunto con la
                          Policía de Guadalajara y la Asociación de Colonos de Providencia, de lo contrario se llamara a vialidad para que retiren el vehículo con grúa sin responsabilidad
                          alguna para los Colonos que lo reporte o del CETI en apego a las reglas de vialidad vigentes.</p>			
                                                                <p class="contenido" >Asimismo se informa que en el estacionamiento para alumnos del CETI se deberán de abstenerse de consumir bebidas alcohólicas o sustancia ilegales, uso de sonido
                          con alto volumen, maniobras riesgosas con vehículos motorizados (carro o motocicletas) y parejas infraganti, en caso de que se sorprenda en cualquiera de
                          estas situaciones podrán ser remitidos conforme a lo que marque las autoridades externas a la Institución. </p>			  
					                                         </div>
				                                            </td>
			                                            </tr>
			                                        </tbody>

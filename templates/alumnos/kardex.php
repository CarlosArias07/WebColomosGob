		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li class='active'><a href='/templates/alumnos/kardex.php'>Kardex</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Kardex</h2>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
											...
											<h4>Requisitos para el trámite de Constancia de Estudios de Todos los Semestres T/S (Kárdex) </h4>
								    		<ul>
											...
											<ul>
											<li>Al recibir tu kárdex debes revisarlo atentamente y de encontrar algún error es necesario lo hagas saber a la persona que te atiende en ventanilla. </li>
											<li>El kárdex incluye el promedio global de las materias cursadas hasta el momento.</li>
											</ul>
											
											<p class='contenido'><b>Duración de trámite: </b> Un día hábil</p>
											<p class='contenido'><b>Costo del trámite: </b> $117.00 (vigentes al 2018) </p>
											<center>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Última actualización: 2018-01-26 19:01:10</p>
								    	</div>
								    </div>
		    					</div>

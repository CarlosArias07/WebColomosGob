		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li class='active'><a href='/templates/alumnos/tramitesEscolares.php'>Trámites escolares</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Trámites Escolares</h2>
					            	...
					            	<div class='col-md-4 col-xs-12 pull-right '>
										...
										<div class='border-box submenu_relacionados'>
									        ...
									        <hr class='red sitios_relacionados'>
									       	<ul>	<li><a href="/templates/alumnos/becas2.php">Becas</a><hr class="sub-hr"></li>	
											        <li><a href="https://ase1.ceti.mx" target="_blank">Calificaciones Alumnos</a><hr class="sub-hr"></li>
                                    ...
                                    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
											...
											<div class="list-group">
											  <a href="/templates/alumnos/certificadoParcial.php" class="list-group-item">Certificado Parcial</a>
											  <a href="/templates/alumnos/certificadoDuplicado.php" class="list-group-item">Certificado Duplicado</a>
											  <a href="/templates/alumnos/justificante.php" class="list-group-item">Justificante</a>
											  <a href="/templates/alumnos/constanciaEstudios.php" class="list-group-item">Constancias de Estudios</a>
											  <a href="/templates/alumnos/kardex.php" class="list-group-item">Kardex</a>
											  <a href="/templates/alumnos/bajaDefinitiva.php" class="list-group-item">Baja Definitiva</a>
											  <a href="/templates/alumnos/bajaTemporal.php" class="list-group-item">Baja Temporal</a>
											  <a href="/templates/alumnos/solicitudCartas.php" class="list-group-item">Solicitud de Cartas</a>
											  <a href="#" class="list-group-item">Credenciales</a>
											  <a href="#" class="list-group-item">Seguro Facultativo</a>
											  <a href="#" class="list-group-item">Servicio Social</a>
											  <a href="#" class="list-group-item">Prácticas Profesionales</a>
											  <a href="#" class="list-group-item">Trámites de Egreso</a>
											  <a href="#" class="list-group-item">Reinscripción</a>
											</div>
									    </div>
								    </div>

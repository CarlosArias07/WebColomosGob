        ...
        <!--  CONTENIDO PÁGINA -->
		  ...
		  <div class='container nota interior ficha'>
								...
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Plataforma Moodle</h2>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
                                             Apoyo en línea de las materias del plan de estudio.
                                             <ul type = circle>
                                             <li>Tecnólogo <a href="http://educa.colomos.ceti.mx/" target="_blank" class="btn btn-primary pull-right">Ingresar</a></li>
                                         	</ul>
                                         	<ul type = circle>
                                             <li>Ingeniería <a href="http://educa.ingenieria.ceti.mx/" target="_blank" class="btn btn-primary pull-right">Ingresar</a></li>
                                         	</ul>
											</p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-11-10 14:14:10</p>
								    	</div>
								    </div>
		    					</div>

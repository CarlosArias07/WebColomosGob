		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li class='active'><a href='/WebColomosGob/templates/noticias/convocatoriaComiteDiCurricular-18-01-18.php'>Convocatoria</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Convocatoria para integrar el comité de diseño curricular</h2>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
											...
											<p>
											<object type"application/pdf" data="../../documentos/noticias/convocatoriaComiteDiCurricular-18-01-18.pdf"  height="990" width="600" > </object>
											<br>
											 <a href="../../documentos/noticias/convocatoriaComiteDiCurricular-18-01-18.pdf" target="_blank">Abrir Convocatoria</a>
											</p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2018-01-22 19:49:10</p>
								    	</div>
								    </div>
		    					</div>

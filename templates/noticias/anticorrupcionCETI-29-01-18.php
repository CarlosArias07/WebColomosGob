		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li class='active'><a href='/WebColomosGob/templates/noticias/anticorrupcionCETI-29-01-18.php'>Código de Conducta</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Código de Conducta del Centro de Enseñanza Tecnica Industrial</h2>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
											...
											<p>
											<object type"application/pdf" data="../../documentos/noticias/anticorrupcionCETI-29-01-18.pdf"  height="990" width="600" > </object>
											<br>
											 <a href="../../documentos/noticias/anticorrupcionCETI-29-01-18.pdf" target="_blank"> Abrir Código de Conducta</a>
											</p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>

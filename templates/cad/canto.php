		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/WebColomosGob/templates/cad/canto.php'>Canto y percusiones</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Canto y Percusiones</h2>

					            	</div>
					            	<div class='col-md-4 col-xs-12 pull-right '>
									    <!--imagen por encima del menu lateral-->
					            		<img class='img img-responsive' src="../../imagenes/cad/canto/canto1.jpg" alt="canto">
										<!--Menu lateral -->
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
											En este taller los alumnos aprenden los aspectos básicos del canto como son: postura, respiración, articulación,
											colocación de la voz, apoyo, pero sobre todo trabajamos en la práctica en escenario para lograr apoyar a
											los alumnos que dicen tener "pánico escénico", procuramos crear un ambiente de esparcimiento y convivencia, combinados con el aprendizaje.
											</p>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-12-15 20:20:10</p>
								    	</div>
								    </div>
		    					</div>

		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/WebColomosGob/templates/cad/radio.php'>Taller de Radio</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Taller de Radio</h2>

					            	</div>
					            	<div class='col-md-4 col-xs-12 pull-right '>
									    <!--imagen por encima del menu lateral-->
					            		<img class='img img-responsive' src="../../imagenes/cad/radio/radio1.jpg" alt="radio">
										<!--Menu lateral -->
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
											En el taller de radio se aprenden distintas actividades, desde el análisis de las estaciones de radio,
											manejo de equipo, dinámicas de programas, así como el uso y manejo efectivo de la voz, aprenderás también
											a presentar canciones y dar a conocer noticas.</p>
											<p class='contenido'>
											Conoceremos un poco de la historia de la radiodifusión como medio de comunicación desde el siglo XX hasta
											nuestros días. Por si fuera poco podrá hacer promocionales, grabaciones de voz y la utilización de efectos,
											así como a manejar algunos programas de edición de audio para poder hacer sus propias producciones.
											Trabajaremos dentro de la cabina de radio para conocer las dinámicas de trabajo y la expresión no verbal,
											así como a identificar el equipo técnico que se utiliza para la realización de una grabación.
											</p>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-12-15 20:58:10</p>
								    	</div>
								    </div>
		    					</div>

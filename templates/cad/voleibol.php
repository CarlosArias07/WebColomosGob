		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/WebColomosGob/templates/cad/voleibol.php'>Voleibol</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Voleibol</h2>

					            	</div>
					            	<div class='col-md-4 col-xs-12 pull-right '>
									    <!--imagen por encima del menu lateral-->
					            		<img class='img img-responsive' src="../../imagenes/cad/voleibol/voleibol1.jpg" alt="voleibol">
										<!--Menu lateral -->
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
											El voleibol es un deporte muy completo y con una amplia gama de posibilidades de acuerdo a la morfología de quien lo práctica
											involucrando capacidades físicas, técnicas y tácticas. Las capacidades físicas que desarrollamos principalmente en el taller
											son la fuerza explosiva, velocidad de reacción y resistencia aeróbica. Trabajamos también los fundamentos técnicos en un nivel
											básico. Además damos a conocer un poco de las tácticas de la disciplina. Los requisitos en la vestimenta son: los días lunes y
											jueves playera naranja y los días martes y viernes playera azul, los días miércoles playera del color a elegir por el alumno,

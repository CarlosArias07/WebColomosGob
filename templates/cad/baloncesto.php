		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/WebColomosGob/templates/cad/baloncesto.php'>Baloncesto</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Baloncesto</h2>

					            	</div>
					            	<div class='col-md-4 col-xs-12 pull-right '>
									    <!--imagen por encima del menu lateral-->
					            		<img class='img img-responsive' src="../../imagenes/cad/baloncesto/baloncesto1.jpg" alt="Baloncesto">
										<!--Menu lateral -->
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
                                            El baloncesto es un deporte muy popular y adaptable que involucra capacidades físicas y técnicas combinadas cuya buena relación
											provoca un correcto desempeño. Las capacidades físicas que desarrollamos principalmente en el taller son la resistencia anaeróbica 
											y la fuerza explosiva. De la mano trabajamos los fundamentos técnicos en un nivel básico a través de ejercicios que involucren el desarrollo
											de las capacidades mencionadas y la coordinación viso motriz del alumno. Los requisitos en la vestimenta son: los días lunes y jueves playera
											azul y los días martes y viernes playera naranja, los días miércoles playera del color a elegir por el alumno, además de que todos los 
											días es necesario zapato tipo tenis y short, licra o pants de acuerdo a preferencia. 
											</p>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-12-15 19:46:10</p>
								    	</div>
								    </div>
		    					</div>

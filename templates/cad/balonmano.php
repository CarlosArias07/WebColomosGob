		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/WebColomosGob/templates/cad/balonmano.php'>Balonmano</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Balonmano</h2>

					            	</div>
					            	<div class='col-md-4 col-xs-12 pull-right '>
									    <!--imagen por encima del menu lateral-->
					            		<img class='img img-responsive' src="../../imagenes/cad/balonmano/balonmano1.jpg" alt="balonmano">
										<!--Menu lateral -->
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
											El taller pretende enseñar los fundamentos técnicos del balonmano y motivar a las personas
											a que se desarrollen tanto físicamente como socialmente, fortaleciendo así el trabajo en equipo.</p>
											<p class='contenido'>
											Traer ropa cómoda y ganas de trabajar y convivir en grupo.
											</p>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-12-15 20:30:10</p>
								    	</div>
								    </div>
		    					</div>

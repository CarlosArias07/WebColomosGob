		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li class='active'><a href='/templates/cad/cad.php'>CAD</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            	...
					            	<div class='col-md-4 col-xs-12 pull-right '>
					            		...
					            		<img class='img img-responsive' src="../../imagenes/cad/cad.jpg" alt="CAD">
										<!--Menu lateral -->
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
											...
											<h4>¿Quiénes somos? </h4>
								    		<p class='contenido'>
                                             En enero de 2008 se funda la Coordinación de Cultura, Arte y Deporte en el Plantel Colomos, que atiende a estudiantes de
											 nivel tecnólogo e ingeniería.
											</p>
											
											<h4>Objetivo</h4>
								    		<p class='contenido'>
                                             Promover y organizar actividades culturales, artísticas y deportivas, para la formación integral de los estudiantes del
											 CETI, Plantel Colomos, y contribuir a fomentar estilos de vida saludables en la comunidad escolar. 
											</p>
											
											
											<h4>Programa de talleres:</h4>
											<p class='contenido'>En 4 períodos al año (dos semestrales y dos inter semestrales) se ofertan lo talleres artísticos y
											deportivos: Los cursos intensivos se realizan en Enero y Julio, y los periodos semestrales son de febrero a junio y
											de agosto a diciembre. Las fechas de inscripción aparecen en el calendario de escolar, y en la sección de alumnos 
											(ase1.ceti.mx) La inscripción es vía electrónica en la sección del alumno y debe completarse entregando la ficha de
											inscripción y una copia que compruebe el número de seguro médico del estudiante, en las oficinas de la Coordinación de Cultura.</p>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-12-07 17:07:10</p>
								    	</div>
								    </div>
		    					</div>

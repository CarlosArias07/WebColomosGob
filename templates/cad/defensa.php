		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/WebColomosGob/templates/cad/defensa.php'>Defensa Personal</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Defensa Personal</h2>

					            	</div>
					            	<div class='col-md-4 col-xs-12 pull-right '>
									    <!--imagen por encima del menu lateral-->
					            		<img class='img img-responsive' src="../../imagenes/cad/defensa/defensa1.jpg" alt="defensa">
										<!--Menu lateral -->
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
											El alumno aprenderá las diferentes maneras de defenderse de alguna agresión tanto física como moral,
											los diferentes alcances de la legítima defensa militar, civil y judicial.</p>
											<p class='contenido'>
											Ropa cómoda y algunos objetos de ayuda didáctica en las diferentes escenas de agresión.
											</p>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-12-15 20:26:10</p>
								    	</div>
								    </div>
		    					</div>

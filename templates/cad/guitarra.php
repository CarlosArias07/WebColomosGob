		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/WebColomosGob/templates/cad/guitarra.php'>Guitarra</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Taller de Guitarra</h2>

					            	</div>
					            	<div class='col-md-4 col-xs-12 pull-right '>
									    <!--imagen por encima del menu lateral-->
					            		<img class='img img-responsive' src="../../imagenes/cad/guitarra/guitarra1.jpg" alt="canto">
										<!--Menu lateral -->
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
											En este taller se trabajan los aspectos básicos de la guitarra y la lectura en el pentagrama llevando el método de Julio Sagreras.
											</p>
											<p class='contenido'>
											Procuramos sobre todo buscar un ambiente de esparcimiento y relajación combinado con la teoría y práctica de la guitarra. 
											</p>

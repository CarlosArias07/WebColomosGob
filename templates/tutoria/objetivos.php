								...
								<div class='row'><div class='col-sm-7 pull-left'>
										...
										<div class='border-box submenu_relacionados'>
									        ...
									        <hr class='red sitios_relacionados'>
									       	<ul>	
											    ...
											    <li><a href="/WebColomosGob/templates/tutoria/materialApoyo.php">Directorio</a><hr class="sub-hr"></li>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-11-31 14:15:10</p>
								    	</div>
								    </div>
		    					</div>

		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li><a href='/WebColomosGob/templates/ofertaEducativa/electromecanica.php'>Electromec&aacute;nica</a></li>
										<li class='active'><a href='/WebColomosGob/templates/ofertaEducativa/electromecanicaMisionVision.php'>Misi&oacute;n Visi&oacute;n</a></li>
										
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Misión y Visión de la Carrera de Tecnólogo en Electromecánica</h2>
					            	...
					            	<div class='col-md-4 col-xs-12 pull-right '>
										...
										<div class='border-box submenu_relacionados'>
									        ...
									        <hr class='red sitios_relacionados'>
									       	<ul>	
											    <li><a href="electromecanica.php">Electromecánica</a><hr class="sub-hr"></li>	
											    <li><a href="electromecanicaPerfilEgreso.php">Perfil de Egreso</a><hr class="sub-hr"></li>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
											...
											<h4>Misi&oacute;n</h4>
								    		<p class='contenido'>
											"Formar profesionales líderes en el área tecnológica a través de la oferta de servicios educativos integrales
											para la generación y aplicación de conocimientos científicos y tecnológicos, que contribuyan al desarrollo sustentable".
                                            </p>
                                            <h4> Visi&oacute;n </h4>
                                             <p class='contenido'>
											 "Ser una institución que se mantiene a la vanguardia con excelencia en educación tecnológica, que impulsa el
                                              desarrollo sustentable del país, mediante la generación de conocimiento e innovación, vinculada con organizaciones
                                              del ámbito tecnológico, que forma redes de colaboración nacional e internacional."
                                              El Modelo Educativo del CETI, promueve una formación integral, de alta calidad científica, tecnológica y humanística
                                              por medio de la adquisición y desarrollo de conocimientos, actitudes, habilidades y valores en una constante de
                                              mejora continua. Así mismo, facilita y dirige el aprendizaje autónomo a través de la solución de problemas, prácticas y
                                              el desarrollo de proyectos innovadores mediante los recursos tecnológicos más avanzados a su alcance."</p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>

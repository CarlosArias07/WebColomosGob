		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/WebColomosGob/templates/ofertaEducativa/industrialMisionVision.php'>Misi&oacute;n Visi&oacute;n</a></li>
										
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Misión y Visión de la Carrera de Ingeniería industrial</h2>

					            	</div>
					            	<div class='col-md-4 col-xs-12 pull-right '>
									    <!--imagen por encima del menu lateral-->
					            		<img class='img img-responsive' src="../../imagenes/ofertaEducativa/industrial.png" alt="industrial"/> 
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
											...
											<h4>Misi&oacute;n</h4>
								    		<p class='contenido'>
               Convertirse en una Ingeniería de vanguardia acorde a las exigencias e innovaciones de la industria y de las actividades económicas en general, con valores,
			   actitudes, aptitudes que respondan al desarrollo científico, tecnológico y comercial de su entorno .</p>
                                            <h4> Visi&oacute;n </h4>
                                             <p class='contenido'>
											  La carrera de Ingeniería Industrial, dependiente del Nivel Licenciatura, es un programa cuya función es la de formar profesionales analíticos,
											  creativos con amplia capacidad de adaptación e innovación de nuevas tecnologías, para desempeñarse en las áreas de Ingeniería,
											  o de cualquier actividad económica e integrarse al sector industrial, de servicios o social para beneficio de la sociedad. </p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-11-21 17:07:00</p>
								    	</div>
								    </div>
		    					</div>

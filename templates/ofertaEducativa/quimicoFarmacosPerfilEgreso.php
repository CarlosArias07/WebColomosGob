		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li><a href='/WebColomosGob/templates/ofertaEducativa/quimicoFarmacos.php'>Quimico Fármacos</a></li>
										<li class='active'><a href='/WebColomosGob/templates/ofertaEducativa/quimicoFarmacosPerfilEgreso.php'>Perfil de Egreso</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Perfil de Egreso de la Carrera de Tecnólogo en Quimico Fármacos</h2>

					            	</div>
					            	<div class='col-md-4 col-xs-12 pull-right '>
									    <!--imagen por encima del menu lateral-->
					            		<img class='img img-responsive' src="../../imagenes/ofertaEducativa/quimicoFarmacos.png" alt="quimicoFarmacos"/> 
										...
										<div class='border-box submenu_relacionados'>
									        ...
									        <hr class='red sitios_relacionados'>
									       	<ul>	
											    <li><a href="quimicoFarmacos.php">Quimico Fármacos</a><hr class="sub-hr"></li>	
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<p class='contenido'>
                                            El  Tecnólogo  químico  en  fármacos,  adquiere  a  lo  largo  de  su  carrera  la  siguiente  
                                             formación académica para realizar con buenos resultados las siguientes actividades: </p>
                                             <ul type="circle">
											    <li>Identifica y describe las diferentes formas farmacéuticas. 
												</li>
												<li>Identifica los componentes de las formas farmacéuticas y la función de cada uno de ellos. 
												</li>
												<li>Ejecuta técnicas oficiales para el análisis químico de los productos farmacéuticos. 
												</li>
												<li>Ejecuta técnicas oficiales para el análisis biológico y microbiológico de los productos farmacéuticos. 
												Describe las operaciones Industriales para la obtención de los diferentes productos farmacéuticos y 
												parámetros que deben vigilarse y controlarse en cada etapa del proceso. 
												<li>Emplea los principios farmacéuticos en la evaluación de productos medicinales naturistas. 
												</li>
												</li>Advierte a la sociedad de los riesgos que puede generar el uso de medicamentos en forma indiscriminada
												y los riesgos que genera la actividad industrial farmacéutica. 
												<li>Aplica los principios biotecnológicos en la producción de productos farmacéuticos. 
												</li>
											 </ul>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-11-09 19:13:00</p>
								    	</div>
								    </div>
		    					</div>

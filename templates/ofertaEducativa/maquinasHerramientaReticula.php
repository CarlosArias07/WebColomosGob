		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/templates/ofertaEducativa/maquinasHerramientaReticula.php'>Ret&iacute;cula</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Ret&iacute;cula Tecnólogo en Maquinas-Herramienta</h2>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
											...
											<p>
											<object type"application/pdf" data="../../documentos/ofertaEducativa/tgomaquinasHerramientaReticula.pdf"  height="500" width="600" > </object>
											<br>
											 <a href="../../documentos/ofertaEducativa/tgomaquinasHerramientaReticula.pdf" target="_blank"> Abrir Ret&iacute;cula </a>
											</p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>

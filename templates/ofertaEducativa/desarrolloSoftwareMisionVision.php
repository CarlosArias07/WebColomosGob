        ...
        <!--  CONTENIDO PÁGINA -->
		  ...
		  <div class='container nota interior ficha'>
								...
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Misión y Visión de la Carrera de Tecnólogo en Desarrollo de Software</h2>
										...
										<div class='border-box submenu_relacionados'>
									        ...
									        <hr class='red sitios_relacionados'>
									       	<ul>	
												...
												<li><a href="../../documentos/ofertaEducativa/tgoPlanDesarrolloSoftware.pdf" target="_blank">Planes y programas</a><hr class="sub-hr"></li>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
											...
											<h4>Misi&oacute;n</h4>
								    		<p class='contenido'>
               La carrera de mecánica automotriz, es un programa cuya función es la de formar tecnólogos profesionales con educación tecnológica, formación integral y pertinente, responsabilidad y
			   superación para desempeñarse en la industria automotriz e integrarse al sector productivo en beneficio de la sociedad.</p>
                                            <h4> Visi&oacute;n </h4>
                                             <p class='contenido'>
											 La carrera de tecnólogo en mecánica automotriz busca convertirse en una especialidad de vanguardia en la formación de profesionales en el área tecnológica,
											 acorde a las exigencias e innovaciones de la industria automotriz con valores,
											 actitudes, aptitudes que respondan al desarrollo científico y tecnológico del desarrollo regional y nacional.
											 </p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-11-09 20:25:10</p>
								    	</div>
								    </div>
		    					</div>

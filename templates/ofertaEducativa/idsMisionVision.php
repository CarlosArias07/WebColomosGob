		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li><a href='/WebColomosGob/templates/ofertaEducativa/ids.php'>Ing. Desarrollo de Software</a></li>
										<li class='active'><a href='/WebColomosGob/templates/ofertaEducativa/idsMisionVision.php'>Misi&oacute;n Visi&oacute;n</a></li>
										
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Misión y Visión de la Carrera de Ingeniería en Dasarrollo de Software</h2>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
											<h4>Misi&oacute;n Institucional</h4>
								    		<p class='contenido'>
											 Formar profesionales en el area tecnologica a traves de la oferta de servicios educativos, para
											 la generacioón y aplicación de conocimientos cientifícos y tecnológicos, que contribuyen al desarrollo reginal y nacional.
											</p>
                                            <h4> Visi&oacute;n institucional </h4>
                                             <p class='contenido'>
											  Ser una institución de venguardia y excelencia en educación tecnológica, que ofrece formación integral
											  y pertinente con reconocimiento nacional e internalcional y que promueve el desarrollo de los mienbros de su comunidad.
											  </p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-11-21 18:25:00</p>
								    	</div>
								    </div>
		    					</div>

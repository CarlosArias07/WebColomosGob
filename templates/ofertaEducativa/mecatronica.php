		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/WebColomosGob/templates/ofertaEducativa/mecatronica.php'>Mecatr&oacute;nica</a></li>
					                </ol>
					            </div>
...
industriales y de servicios con un enfoque mecánico, electrónico, robótico y de
automatización, con un sentido de responsabilidad con su entorno sociocultural y
ambiental.</p>
<p class='contenido'>Esta carrera cuenta con cuatro módulos optativos de áreas de formación: Biomédica,
Automotriz, Robótica y Productividad, que permiten que el alumno elija el tipo de
formación acorde a sus aspiraciones profesionales.
 </p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>

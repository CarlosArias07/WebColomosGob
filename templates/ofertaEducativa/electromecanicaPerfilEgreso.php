		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/WebColomosGob/templates/ofertaEducativa/electromecanicaPerfilEgreso.php'>Perfil de Egreso</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Perfil de Egreso de la Carrera de Tecnólogo en Electromec&aacute;nica</h2>
					            	...
					            	<div class='col-md-4 col-xs-12 pull-right '>
										...
										<div class='border-box submenu_relacionados'>
									        ...
									        <hr class='red sitios_relacionados'>
									       	<ul>	
											    <li><a href="electromecanica.php">Quimico Fármacos</a><hr class="sub-hr"></li>	
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<p class='contenido'>
                                            El perfil de egreso del Tecnólogo en Electromecánica es resultado de estudios de pertinencia correspondientes, el
                                            cual se enuncia a continuación: </p>
											<p class='contenido'>
                                        Diseña, opera, supervisa, y da mantenimiento a instalaciones eléctricas, sistemas de control eléctrico - electrónico
                                        industrial, administrando el consumo y ahorro de energía eléctrica; opera y da mantenimiento a máquinas eléctricas,
                                        equipos eléctricos - electrónicos y sistemas electromecánicos, en las áreas eléctrica, electrónica y electromecánica,
                                        aplicando la normatividad vigente en la generación y distribución de energía eléctrica, desempeñándose con actitud
                                        emprendedora, desempeñándose de manera efectiva en equipos de trabajo, con responsabilidad, compromiso social,ético y de sustentabilidad. 
                                         </p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>

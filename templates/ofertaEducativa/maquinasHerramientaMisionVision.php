		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
										...
										<li class='active'><a href='/templates/ofertaEducativa/maquinasHerramienta.php'>Maquinas-Herramienta</a></li>
										<li class='active'><a href='/templates/ofertaEducativa/maquinasHerramientaMisionVision.php'>Misi&oacute;n Visi&oacute;n</a></li>
										
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Misión y Visión de la Carrera de Tecnólogo en Maquinas-Herramienta</h2>

					            	</div>
					            	<div class='col-md-4 col-xs-12 pull-right '>
									    <!--imagen por encima del menu lateral-->
					            		<img class='img img-responsive' src="../../imagenes/ofertaEducativa/maquinasHerramienta.png" alt="maquinasHerramienta"/> 
										...
										<div class='border-box submenu_relacionados'>
									        ...
									        <hr class='red sitios_relacionados'>
									       	<ul>	
												...
												<li><a href="../../documentos/ofertaEducativa/tgoPlanMaquinasHerramienta.pdf" target="_blank">Planes y programas</a><hr class="sub-hr"></li>

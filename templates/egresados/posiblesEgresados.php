        ...
        <!--  CONTENIDO PÁGINA -->
		  ...
		  <div class='container nota interior ficha'>
								...
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Listas de Posibles Egresados</h2>
					            	...
					            	<div class='col-md-4 col-xs-12 pull-right '>
                                        ...
                                        <div class='border-box submenu_relacionados'>
                                          <h4 class='bottom-buffer'>Sitios relacionados</h4>
                                            ...
                                            <ul>
                                            <li><a href="http://www.colomos.ceti.mx/">Lista de Egresados</a><hr class="sub-hr"></li>   
                                            </ul>
                                        </div> 
								    </div>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-11-16 14:24:47</p>
								    	</div>
								    </div>
		    					</div>

		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li>Aspirantes</li>
					                    <li class='active'><a href='/WebColomosGob/templates/aspirantes/cursoPropedeutico.php'>Curso Propedéutico</a></li>
					                </ol>
					            </div>
										...
										<div class='border-box submenu_relacionados'>
									        ...
									        <hr class='red sitios_relacionados'>
									       	<ul>	
											    ...
											    <li><a href="#">Material de Apoyo</a><hr class="sub-hr"></li>	
											</ul>

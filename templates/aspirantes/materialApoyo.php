		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li class='active'><a href='/WebColomosGob/templates/aspirantes/materialApoyo.php'>Material de Apoyo</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Material de Apoyo</h2>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class='contenido'>
                                             <p>Nivel Tecnologo y Nivel Ingeniería <a href="https://propedeutico.ceti.mx/" target="_blank" class="btn btn-primary pull-right" >Consultar</a><p>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-11-06 11:37:10</p>
								    	</div>
								    </div>
		    					</div>

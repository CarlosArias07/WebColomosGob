		  ...
		  <div class='container nota interior ficha'>
		    					<div class='col-md-12 col-sm-12 col-xs-12'>
					                <ol class='breadcrumb'>
					                    ...
					                    <li>Docentes</li>
					                    <li class='active'><a href='/WebColomosGob/templates/alumnos/reglamentosManuales.php'>Reglamentos y Manuales</a></li>
					                </ol>
					            </div>
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Reglamentos y Manuales</h2>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
								    		<p class="contenido">
                                             	Procedimiento para el proceso de Aprendizaje y  <a href="/WebColomosGob/documentos/alumnos/DI-RG-200-09-01 REV. C REGLAMENTO DE ESTUDIANTES EMS.pdf" target="_blank" class="btn btn-primary pull-right">Consultar</a>
                                             <br>
                                             	Evaluación del Aprendizaje
                                         	 </p>
                                             <p class="contenido">
                                             	Manual de la Función Docente <a href="/WebColomosGob/documentos/alumnos/DI-RG-200-09-02 REV. C REGLAMENTO DE ESTUDIANTES ES.pdf" target="_blank" class="btn btn-primary pull-right">Consultar</a>
                                             <br>
                                             <br>
                                         	 </p>
                                         	 <p class="contenido">
                                             	Manual de Organización y Funcionamiento de las  <a href="/WebColomosGob/documentos/alumnos/DI-RG-200-03-02 REV. J REGLAMENTO BECAS.pdf" target="_blank" class="btn btn-primary pull-right">Consultar</a>
                                             <br>
                                             	Coordinaciones de División
                                         	 </p>
                                         	 <p class="contenido">
                                             	Reglamento de Organizacion y Funcionamiento de  <a href="/WebColomosGob/documentos/alumnos/DI-RG-200-10-07 Reglamento de Servicio Social de Educación Media Superior.pdf" target="_blank" class="btn btn-primary pull-right">Consultar</a>
                                             <br>
                                             	Academias
                                         	 </p>
								 ...
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-11-13 12:50:52</p>
								    	</div>
								    </div>
		    					</div>

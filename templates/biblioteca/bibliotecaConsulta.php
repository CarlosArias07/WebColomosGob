        ...
        <!--  CONTENIDO PÁGINA -->
		  ...
		  <div class='container nota interior ficha'>
								...
								<div class='row'><div class='col-sm-7 pull-left'>
					            		<h2 class='bottom-buffer'>Consulta</h2>
								    ...
								    <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		<hr class='red'>
											<p class='contenido'>
											 <p>Listado de Tesis <a href="../../documentos/biblioteca/registrodeTesis32016.xlsx" target="_blank" class="btn btn-primary pull-right" >Consultar</a><p>
											 <p>Listado de Material de Audiovisual <a href="../../documentos/biblioteca/materialAudiovisual.xlsx" target="_blank" class="btn btn-primary pull-right" >Consultar</a><p>
								    	</div>
								    </div>
								 <div class='col-sm-7 pull-left'>
								    	<div class='article-body'>
								    		...
								    		<hr class=''>
								    		<p class='ultima_actualizacion'>Ultima actualización: 2017-12-06 17:52:10</p>
								    	</div>
								    </div>
		    					</div>

					            	...
					            	<div class='col-md-4 col-xs-12 pull-right '>
										...
										<div class='border-box submenu_relacionados'>
									        ...
									        <hr class='red sitios_relacionados'>
									       	<ul type="circle">	<li><a href="/documentos/biblioteca/reglamentoBiblioteca.pdf" target="_blank">Reglamento</a><hr class="sub-hr"></li>	
											                    <li><a href="/templates/biblioteca/bibliotecaVirtual.php">Biblioteca Virtual</a><hr class="sub-hr"></li>
																<li><a href="/templates/biblioteca/bibliotecaConsulta.php">Consulta</a><hr class="sub-hr"></li>
